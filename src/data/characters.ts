export const characters = [
    ...
    },
    {
        name: "Nash Wallace",
        age: 18,
        slugs: ["Speedstinger", "Fungaroo", "Ramstone", "Dreamiese"],
    ...
    },
    {
        name: "Salem Kahue",
        age: 17,
        slugs: ["Tenasher", "Slicksilver", "Hoprock", "Gyrophyll"],
        description: "Salem is a cunning and sly sniper from the Temporal Jungle, a region vital to have great camouflage skills. He claims to have never missed a shot with his good buddy Chompy the Tenasher.",
        image: "Salem.svg"
    }
]
